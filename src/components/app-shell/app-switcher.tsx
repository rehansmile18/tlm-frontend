...
// This app IS the Rule Repository, so its own entry is always "active" regardless of whether
// NEXT_PUBLIC_SITE_OPS_APP_URL happens to be configured — the other app's url is a real
// cross-origin navigation, not a Next.js route, and only that entry depends on the env var.
const APPS = [
  { key: "ruleRepositoryApp" as const, url: undefined, active: true },
  { key: "siteOperationsApp" as const, url: process.env.NEXT_PUBLIC_SITE_OPS_APP_URL, active: false },
];
